...
const MovieCard: React.FC<MovieCardProps> = ({data}) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <img
        className="cursor-pointer object-cover transition duration shadow-xl rounde-md 
        group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-[12vw]"
        src={data.thumbnailUrl}
        alt="thumbnail"
      />
      <div
        className="opacity-0 transition duration-200 z-10 invisible 
      sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw]
      group-hover:translater-x-[2vw] group-hover:opacity-100 absolute top-0 "
      >
        <img
        ...
        />
        <div
          className="z-10 bg-zinc-800 absolute lg:p-4 p-2 w-full 
        ...
        >
          <div className="flex flex-row items-center gap-3">
            ...
            <div
              ...
              group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2
